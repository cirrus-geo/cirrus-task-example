...
@pytest.mark.parametrize("input_file, expected_output_file, expect_exception", get_test_cases())
def test_task(input_file: Path, expected_output_file: Path, expect_exception: bool) -> None:
